...
@Composable
fun FormularioCcarHechoAprehendido(context: Context, navController: NavController) {
    ...
    var aprehendio by remember { mutableStateOf("") }
    ...
    FormConAprehendido(
        ...
        aprehendido = DatosFormulario("Aprehendido/s", { aprehendio = it }, aprehendio),
...
private fun FormConAprehendido(
    ...
    Row(
        ...
        TextField(
            value = aprehendido.value,
            onValueChange = aprehendido.onChange,
            label = { Text(text = aprehendido.name) },
            singleLine = true,
            maxLines = 1,
            modifier = Modifier
                .width(400.dp)
...
private fun crearExtractoAprehendido(
    ipp: DatosFormulario,
    caratula: DatosFormulario,
    jurisdiccion: DatosFormulario,
    denunciante: DatosFormulario,
    ...
    var aprehendidoVar = ""
    if (aprehendido.value != "") {
        aprehendidoVar = "\n\n*${aprehendido.name.uppercase().trim()}:* ${aprehendido.value.trim()}"
    }
    var intervencionVar = ""
    ...
    val extracto =
        fecha + encabezado + denuncianteVar + aprehendidoVar + intervencionVar + genesis + firma
